...
(:action catalytichydrogenationofalkenes
    :parameters (?c_3 - carbon ?h_5 - hydrogen ?c_4 - carbon ?h_6 - hydrogen)
    :precondition
    (and
        (not (= ?c_4 ?c_3))
        (doublebond ?c_4 ?c_3)
...
(:action hydrolysisofnitriles
    :parameters (?h_6 - hydrogen ?o_4 - oxygen ?o_7 - oxygen ?h_5 - hydrogen ?n_1 - nitrogen ?h_8 - hydrogen ?c_2 - carbon ?c_3 - carbon ?h_9 - hydrogen)
    :precondition
    (and
        (not (= ?h_5 ?h_6))
        (not (= ?h_5 ?h_8))
...
(:action iminereductiontoamine
    :parameters (?al_10 - aluminium ?h_7 - hydrogen ?o_6 - oxygen ?n_1 - nitrogen ?c_2 - carbon ?h_11 - hydrogen ?r1_3 - hc ?r1_4 - hc ?r1_5 - hc ?h_8 - hydrogen ?h_12 - hydrogen ?h_13 - hydrogen ?h_14 - hydrogen)
    :precondition
    (and
        (not (= ?h_7 ?h_11))
        (not (= ?r1_4 ?r1_5))
