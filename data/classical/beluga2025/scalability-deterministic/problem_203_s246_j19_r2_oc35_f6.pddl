(define
	(problem beluga-problem_203_s246_j19_r2_oc35_f6)
	(:domain beluga)
  (:objects
  ...
  (:init
		...
		; 0: jig0002 1: jig0003 2: jig0004 3: jig0005 4: jig0006 5: jig0007 6: jig0008 7: jig0009
		...
		(next_load typeA slot4 slot5 beluga5)
		(next_load dummy-type slot5 dummy-slot beluga5)
		; 0: typeA 1: typeA
		...
		; Production schedule:
		; Production line: pl0
		; 0: jig0003 1: jig0007 2: jig0008 3: jig0004 4: jig0011 5: jig0013 6: jig0010 7: jig0017
		...
		; Production line: pl1
		; 0: jig0002 1: jig0005 2: jig0009 3: jig0001 4: jig0006 5: jig0012 6: jig0014 7: jig0015
