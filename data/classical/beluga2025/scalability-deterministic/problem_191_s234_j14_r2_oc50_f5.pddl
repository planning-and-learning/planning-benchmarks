(define
	(problem beluga-problem_191_s234_j14_r2_oc50_f5)
	(:domain beluga)
  (:objects
  ...
  (:init
		...
		; 0: jig0005 1: jig0006 2: jig0007 3: jig0008 4: jig0009 5: jig0010 6: jig0011
		...
		(next_load typeA slot7 slot8 beluga4)
		(next_load dummy-type slot8 dummy-slot beluga4)
		; 0: typeA
		(to_load typeA slot0 beluga5)
		(next_load dummy-type slot0 dummy-slot beluga5)
		; Production schedule:
		; Production line: pl0
		; 0: jig0004 1: jig0009 2: jig0011 3: jig0005 4: jig0008 5: jig0012
		...
		; Production line: pl1
		; 0: jig0001 1: jig0006 2: jig0010 3: jig0002 4: jig0007 5: jig0013
