(define (problem tpp-g8-t1-m8-d2-l10)
  ...
  (:init
    ...
    (on-sale goods0 market6 level10)
    ...
    (on-sale goods5 market5 level10)
    ...
    (on-sale goods6 market0 level10)
