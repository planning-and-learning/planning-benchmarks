(define (problem tpp-g7-t2-m10-d1-l9)
  ...
  (:init
    ...
    (on-sale goods5 market8 level9)
    (ready-to-load goods5 market8 level0)
    (on-sale goods5 market9 level9)
