(define (problem tpp-g8-t1-m10-d2-l9)
  ...
  (:init
    ...
    (on-sale goods0 market8 level7)
    (ready-to-load goods0 market8 level0)
    (on-sale goods0 market9 level3)
    ...
    (on-sale goods5 market8 level8)
    (ready-to-load goods5 market8 level0)
    (on-sale goods5 market9 level5)
