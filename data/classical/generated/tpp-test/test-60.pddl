(define (problem tpp-g7-t2-m10-d1-l10)
  ...
  (:init
    ...
    (on-sale goods1 market4 level10)
    ...
    (on-sale goods3 market5 level10)
    ...
    (on-sale goods6 market5 level10)
    (ready-to-load goods6 market5 level0)
    (on-sale goods6 market6 level9)
