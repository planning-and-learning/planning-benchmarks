(define (problem tpp-g7-t1-m10-d1-l9)
  ...
  (:init
    ...
    (on-sale goods3 market8 level9)
    (ready-to-load goods3 market8 level0)
    (on-sale goods3 market9 level3)
    ...
    (on-sale goods5 market6 level9)
    (ready-to-load goods5 market6 level0)
    (on-sale goods5 market7 level7)
    (ready-to-load goods5 market7 level0)
    (on-sale goods5 market8 level4)
