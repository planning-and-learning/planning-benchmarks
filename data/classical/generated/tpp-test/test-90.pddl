(define (problem tpp-g8-t1-m10-d1-l8)
  ...
  (:init
    ...
    (on-sale goods2 market7 level4)
    (ready-to-load goods2 market7 level0)
    (on-sale goods2 market8 level5)
    ...
    (on-sale goods7 market8 level2)
    (ready-to-load goods7 market8 level0)
    (on-sale goods7 market9 level4)
