(define (problem tpp-g7-t1-m10-d1-l8)
  ...
  (:init
    ...
    (on-sale goods0 market7 level5)
    (ready-to-load goods0 market7 level0)
    (on-sale goods0 market8 level6)
    ...
    (on-sale goods2 market8 level8)
    (ready-to-load goods2 market8 level0)
    (on-sale goods2 market9 level4)
