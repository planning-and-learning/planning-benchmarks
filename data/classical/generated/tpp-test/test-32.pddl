(define (problem tpp-g7-t1-m10-d2-l10)
  ...
  (:init
    ...
    (on-sale goods2 market4 level8)
    (ready-to-load goods2 market4 level0)
    (on-sale goods2 market5 level9)
    (ready-to-load goods2 market5 level0)
    (on-sale goods2 market6 level4)
    ...
    (on-sale goods4 market3 level10)
    (ready-to-load goods4 market3 level0)
    (on-sale goods4 market4 level6)
    ...
    (on-sale goods4 market8 level8)
    (ready-to-load goods4 market8 level0)
    (on-sale goods4 market9 level8)
    ...
    (on-sale goods6 market6 level10)
