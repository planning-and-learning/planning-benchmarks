(define (problem tpp-g8-t1-m9-d1-l10)
  ...
  (:init
    ...
    (on-sale goods1 market5 level7)
    (ready-to-load goods1 market5 level0)
    (on-sale goods1 market6 level8)
    ...
    (on-sale goods2 market0 level10)
    ...
    (on-sale goods2 market8 level10)
    ...
    (on-sale goods5 market3 level10)
