(define (problem tpp-g8-t1-m10-d2-l8)
  ...
  (:init
    ...
    (on-sale goods3 market7 level5)
    (ready-to-load goods3 market7 level0)
    (on-sale goods3 market8 level7)
    ...
    (on-sale goods4 market8 level7)
    (ready-to-load goods4 market8 level0)
    (on-sale goods4 market9 level6)
    ...
    (on-sale goods5 market4 level7)
    (ready-to-load goods5 market4 level0)
    (on-sale goods5 market5 level6)
    ...
    (on-sale goods5 market8 level6)
    (ready-to-load goods5 market8 level0)
    (on-sale goods5 market9 level7)
