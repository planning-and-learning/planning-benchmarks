(define (problem tpp-g7-t1-m10-d2-l9)
  ...
  (:init
    ...
    (on-sale goods0 market6 level7)
    (ready-to-load goods0 market6 level0)
    (on-sale goods0 market7 level7)
