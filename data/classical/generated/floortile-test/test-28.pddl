(define (problem floortile-r8-c9-rob4)
  (:domain floor-tile)
  (:objects
    tile_0-1 tile_0-2 tile_0-3 tile_0-4 tile_0-5 tile_0-6 tile_0-7 tile_0-8 tile_0-9
    ...
    tile_8-1 tile_8-2 tile_8-3 tile_8-4 tile_8-5 tile_8-6 tile_8-7 tile_8-8 tile_8-9 - tile
    robot1 robot2 robot3 robot4 - robot
    white black - color
  )
  (:init
    (= (total-cost) 0)
    (robot-at robot1 tile_8-6)
    (robot-has robot1 white)
    (robot-at robot2 tile_7-9)
    (robot-has robot2 black)
    (robot-at robot3 tile_1-7)
    (robot-has robot3 white)
    (robot-at robot4 tile_7-8)
