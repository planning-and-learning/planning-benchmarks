(define (problem floortile-r7-c10-rob4)
  (:domain floor-tile)
  (:objects
    ...
    tile_7-1 tile_7-2 tile_7-3 tile_7-4 tile_7-5 tile_7-6 tile_7-7 tile_7-8 tile_7-9 tile_7-10 - tile
    robot1 robot2 robot3 robot4 - robot
    white black - color
  )
  (:init
    (= (total-cost) 0)
    (robot-at robot1 tile_2-8)
    (robot-has robot1 white)
    (robot-at robot2 tile_1-10)
    (robot-has robot2 black)
    (robot-at robot3 tile_6-6)
