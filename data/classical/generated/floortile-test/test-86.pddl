(define (problem floortile-r9-c8-rob4)
  (:domain floor-tile)
  (:objects
    tile_0-1 tile_0-2 tile_0-3 tile_0-4 tile_0-5 tile_0-6 tile_0-7 tile_0-8
