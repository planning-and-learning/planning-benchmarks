(define (problem barman-c7-i13-s13-g12-ig100)
  (:domain barman)
  (:objects
      left right - hand
      shaker1 - shaker
  ...
  (:goal
    (and
      (contains shot1 ingredient12)
      (contains shot2 ingredient7)
      (contains shot3 ingredient1)
      (contains shot4 ingredient12)
      (contains shot5 ingredient12)
      (contains shot6 ingredient12)
      (contains shot7 ingredient1)
      (contains shot8 ingredient2)
      (contains shot9 ingredient11)
