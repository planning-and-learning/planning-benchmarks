(define (problem goldminer-r3-c7)
  (:domain gold-miner-typed)
  (:objects
    f0-0f f0-1f f0-2f f0-3f f0-4f f0-5f f0-6f f1-0f f1-1f f1-2f f1-3f f1-4f f1-5f f1-6f f2-0f f2-1f f2-2f f2-3f f2-4f f2-5f f2-6f - LOC
  )
  (:init
    (arm-empty)
