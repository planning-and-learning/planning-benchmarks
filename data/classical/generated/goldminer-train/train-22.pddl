(define (problem goldminer-r4-c5)
  (:domain gold-miner-typed)
  (:objects
    f0-0f f0-1f f0-2f f0-3f f0-4f f1-0f f1-1f f1-2f f1-3f f1-4f f2-0f f2-1f f2-2f f2-3f f2-4f f3-0f f3-1f f3-2f f3-3f f3-4f - LOC
  )
  (:init
    (arm-empty)
