...
GENERATOR_DIR = ROOT_DIR / "generators" / "classical" / "grid"
sys.path.insert(0, str(ROOT_DIR))

from generators.classical.grid import make_problem  # noqa: E402
...
STRUCTURAL_SPACES = {
    "train": cartesian(range(2, 5), range(2, 5), range(1, 3), range(1, 4), range(1, 4), [0.5, 1.0]),
    "valid": cartesian(range(5, 7), range(5, 7), range(2, 4), range(3, 5), range(3, 5), [0.5, 1.0]),
    "test": cartesian(range(7, 9), range(7, 9), range(3, 5), range(4, 7), range(4, 7), [0.5, 1.0]),
}
