...
GENERATOR_DIR = ROOT_DIR / "generators" / "classical" / "blocks_3"
sys.path.insert(0, str(ROOT_DIR))

from generators.classical.blocks_3.generator import make_problem  # noqa: E402
...
STRUCTURAL_SPACES = {
    "train": cartesian(range(3, 8)),
    "valid": cartesian(range(8, 12)),
    "test": cartesian(range(12, 19)),
}
