(define
    (domain m18)
    (:requirements :typing :strips :conditional-effects :negative-preconditions :existential-preconditions :universal-preconditions)
    ...
    (:constants
        ...
        m1 m2 m3 m4 m5 m6 m7 m8 m9 m10 m11 m12 m13 m14 m15 m16 m17 m18 - moveable-object
    ...
    (:action move-agent
        ...
        :precondition (and
            ...
            (not (should-move m15 left))
            (not (should-move m15 right))
            (not (should-move m15 up))
            (not (should-move m15 down))
            (not (should-move m16 left))
            (not (should-move m16 right))
            (not (should-move m16 up))
            (not (should-move m16 down))
            (not (should-move m17 left))
            (not (should-move m17 right))
            (not (should-move m17 up))
            (not (should-move m17 down))
            (not (should-move m18 left))
            (not (should-move m18 right))
            (not (should-move m18 up))
            (not (should-move m18 down))
        )
        :effect (and
